...
Готовая статичная страница с оригинальной типографикой, двумя видеосценами, переключением картин и десяти глав истории. Интерактивная зона представлена отдельным блоком: стенды, сенсорные панели, разговор с цифровым Пушкиным, 3D-голограммы и фотозоны. Добавлена таблица цен на будни и выходные из прайса, который пользователь предоставил 8 сентября 2026 года с просьбой разместить его на сайте.
...
Фотографии и оба ролика находятся в `assets`; онлайн-вставки используют их адреса jsDelivr, закреплённые за коммитом с материалами. Шрифты встроены в HEAD. Цены доступны; точное расписание сеансов и ссылка билетного оператора пока не предоставлены. Для подключения покупки укажите реальную ссылку в `PUSHKIN_EXHIBIT_CONFIG.ticketUrl` в FOOTER.
